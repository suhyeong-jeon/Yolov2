...
def build_target(output, gt_data, H, W):
    ...
    """
    delta_pred_batch = output[0] # predicted x, y, h, w
    conf_pred_batch = output[1] # predicted confidence score
    class_score_batch = output[2] # predicted class score

    gt_boxes_batch = gt_data[0] # ground truth x, y, h, w
    gt_classes_batch = gt_data[1] # ground truth classes
    num_boxes_batch = gt_data[2] # ground truth num_boxes
